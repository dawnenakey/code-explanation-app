    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="text-center mb-12">
          <h2 className="text-3xl font-bold text-gray-900 mb-4">Understand Any Code Instantly</h2>
          <p className="text-lg text-gray-600 max-w-2xl mx-auto">
            Paste your code snippet and get clear, beginner-friendly explanations powered by AI. 
            ...
            <CardContent className="p-6">
              ...
              {explanation && !explainCodeMutation.isPending && (
                <div className="space-y-6">
                  ...
                  {explanation.performanceNotes && (
                    <div>
                      <h4 className="text-base font-semibold text-gray-900 mb-2">⚠️ Performance Note</h4>
