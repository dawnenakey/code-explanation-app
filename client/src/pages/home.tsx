              ...
              <CardContent className="p-6">
                ...
                {explanation && !explainCodeMutation.isPending && (
                    <div className="space-y-6">
                      ...
                      {explanation.blackboxComponents && explanation.blackboxComponents.length > 0 && (
                          <div>
                            <h4 className="text-base font-semibold text-gray-900 mb-2">🔐 Enterprise Security Analysis</h4>
                            <div className="space-y-3">
                              {explanation.blackboxComponents.map((component, index) => {
                                const riskColors = {
                                ...
                                return (
                                    <div key={index} className={`${riskColors[component.riskLevel]} border p-3 rounded-md`}>
                                      <div className="mb-2">
                                        <div className="flex items-center justify-between">
                                          <span className="text-sm font-medium text-gray-900">{component.name}</span>
                                          <span className={`text-xs px-2 py-1 rounded-full ${riskTextColors[component.riskLevel]} bg-opacity-20`}>
                                    {component.isBlackbox ? "🔒 Blackbox" : "👁️ Transparent"} • {component.riskLevel.toUpperCase()} Risk
                                  </span>
                                        </div>
                                        <p className="text-xs text-gray-600 mt-1">{component.type}</p>
                                      </div>
                                      <div className="mb-2">
                                      ...
                                      {component.recommendations.length > 0 && (
                                          <div>
                                            ...
                                            <ul className="text-sm text-gray-700 mt-1 ml-4 space-y-1">
